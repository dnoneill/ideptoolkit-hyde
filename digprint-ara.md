...
5. 2 كابل لتمديد طقم الاضاءه.
![](../assets/img/digprint/image2.png)
6. 2 صندوق خفيف/لين
![](../assets/img/digprint/image12.png)

7. 4 حلقة سرعة، ملاحظة: هناك حاجة لعدد إثنين فقط؛ والثانية هي البديل الاحتياطي في حالة الكسر.
![](../assets/img/digprint/image33.png)
8. 2 حامل خفيف – يتم تركيها بالعكس ، لذلك سوف تبدو وكأنها على شكل الرقم 1 ![Figure 1](../assets/img/digprint/image11.png) , حتى يتم تمديدها بالكامل لتبدو  مثل الشكل 2.
